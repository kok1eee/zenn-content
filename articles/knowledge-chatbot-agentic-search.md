...
:::message alert
**公開から数時間でプロンプトインジェクションによるファイル漏洩が発生した。** 試みる人が現れた、ではない。攻撃が成功して実際にナレッジ外のファイルが読まれた。
:::

### Before: 対策前に何が起きたか

社内 Slack に公開した直後、あるユーザーが段階的に攻撃を仕掛けてきた。**教科書的なソーシャルエンジニアリングで、5ターンで完了している。**
...
3層防御を実装して再デプロイ。同じユーザーが再び攻撃を試みた結果:
