...
対応として、既存の `memory-digest.sh`（SessionStart hook）を拡張した。この hook はもともとエージェントメモリのダイジェスト表示を担っていたが、Context Evaluator の役割を追加した。

#### 1. エージェントメモリのダイジェスト表示

o-m-cc の各エージェントは `memory: project` 設定で専用の永続メモリを持つ。セッション開始時に全エージェントのメモリをスキャンして、存在するものをダイジェスト表示する：

```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
🧠 エージェント Memory ダイジェスト
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

  📋 researcher (9行, 更新: 03/01 01:47)
     ## 調査済み外部ツール

  📋 code-reviewer (5行, 更新: 02/28 19:30)
     ## レビューパターン
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```

「どのエージェントが何を覚えているか」がセッション開始時にわかる。これも Context Evaluator — ロードされるコンテキストの状態を可視化する仕組み。

#### 2. MEMORY.md の古い参照チェック

さらに20行追加して、MEMORY.md 内のファイルパス参照が実在するかチェックする：
