...
VentureBeatの報道によると、「エンタープライズAPIゲートウェイを経由してコンシューマーOAuth制限を回避している」と**報じられています（reportedly）**。
...
でも冷静に考えると、**oh-my-opencodeでChatGPT/Geminiも使える**んだよね。マルチプロバイダー対応だから、Claude制限きたら他に切り替える、みたいな使い方ができる。
