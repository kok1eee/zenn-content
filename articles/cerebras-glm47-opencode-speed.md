...
Composer、Windsurfと、高速推論サービスが次々と登場してる。

そして今度は**GLM-4.7**。Cerebras上で動作して、**約1,000トークン/秒**。Claude Sonnet 4.5の10倍速いらしい。

コード生成、ツール駆動型エージェント、マルチターン推論に特化。**まさにAIコーディングエージェント向け**。

### なぜ気になるのか

私はClaude CodeとOpenCodeを使い分けてる。

コーディングエージェントで大事なのは**ハーネス**。ファイル操作、Git連携、MCP、エージェント機構...これらが揃った環境で動かしたい。

だから「速いモデルが出た！」と言われても、**使い慣れたハーネスの中で動かせるか**が重要。

OpenCodeならCerebras対応してる。これは試す価値がある。
...
- [Cerebras GLM-4.7 発表](https://www.cerebras.ai/blog/glm-4-7)
